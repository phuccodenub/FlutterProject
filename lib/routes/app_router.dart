...
import '../screens/teacher/students/student_detail_screen.dart'
    as teacher_student;
import '../screens/teacher/analytics/instructor_analytics_screen.dart';

// Student screens - Analytics
import '../screens/student/analytics/student_analytics_screen.dart';
...
final appRouterProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    redirect: (context, state) {
      // Check if user logged out and redirect to login
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            ...
            redirect: (context, state) => requireAuth(context, state),
            builder: (context, state) => const InstructorAnalyticsScreen(),
          ),
        ],
      ),
