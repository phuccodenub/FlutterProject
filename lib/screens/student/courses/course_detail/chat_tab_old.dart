              ...
              TextButton.icon(
                onPressed: () {
                  ref
                      ...
                      .simulateOnlineUsers(
                        widget.courseId,
                        currentUserRole: auth.user?.role.name ?? 'student',
                      );
                },
                    ...
                    children: [
                      ...
                      if (m.attachmentPath != null) ...[
                        ...
                        if (_isImageFile(m.attachmentPath))
                          ...
                          GestureDetector(
                            onTap: () =>
                                _showImageViewer(context, m.attachmentPath!),
                            child: Container(
            ...
            children: [
              Expanded(
                child: TextField(
                  ...
                  onChanged: (_) {
                    ...
                    ref
                        .read(chatProvider.notifier)
                        .setTyping(widget.courseId, int.parse(user.id), true);
              ...
              IconButton(
                ...
                onPressed: () {
                  ...
                  ref
                      .read(chatProvider.notifier)
                      .updateLastSeen(int.parse(user.id));
                  ctrl.clear();
                  setState(() {
                    attachPath = null;
                    attachName = null;
